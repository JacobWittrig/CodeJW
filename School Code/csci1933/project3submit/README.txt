...
The is sorted test cases do not pass. No matter what I did, there were some that could not be passed.
In the linked list two empty lists were passed in, and for some reason one was true and one was false in the test
cases. In the array test, a previously sorted list was reversed and should have not been sorted,
but the test case required it to be sorted. Therefore, I gave up after a couple days of work.
