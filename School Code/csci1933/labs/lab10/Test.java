...
public class Test {
    ...
    */
    ...
    public static void testPathExists() {
        ...
        System.out.println("Path Exists Test 1: " + PathExists.doesPathExist(grid1, 4, 4));
        for (char[] row : grid1) {
        ...
        System.out.println("Path Exists Test 2: " + PathExists.doesPathExist(grid2, 4, 4));
        for (char[] row : grid2) {
            for (char c : row) System.out.print(c + " ");
            System.out.println();
        }
        ...
        System.out.println("Path Exists Test 3: " + PathExists.doesPathExist(grid3, 1, 1));
        for (char[] row : grid3) {
            for (char c : row) System.out.print(c + " ");
            System.out.println();
        }
        ...
        System.out.println("Path Exists Test 4: " + PathExists.doesPathExist(grid4, 0, 1));
        for (char[] row : grid4) {
            for (char c : row) System.out.print(c + " ");
            System.out.println();
        }
